...
namespace FitnessApp_CQRS_OData.Web.Attributes
{
        ...
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            if (descriptor != null && descriptor.FilterDescriptors.Any(filter => filter.Filter is Microsoft.AspNetCore.OData.Query.EnableQueryAttribute))
            {
                operation.Parameters.Add(new OpenApiParameter()
                {
                    ...
                    Description = "Returns only the selected properties. (ex. Id, Title)",
                    Required = false
                });
                ...
                operation.Parameters.Add(new OpenApiParameter()
                {
                    ...
                    Description = "Include only the selected objects. (ex. Id, Title)",
                    Required = false
                });
                ...
                operation.Parameters.Add(new OpenApiParameter()
                {
                    ...
                    Description = "Define the order by one or more fields (ex. Created, Updated)",
                    Required = false
                });
